...
from training.train_wrapper import TrainWrapper, data_loader
...
if __name__ == '__main__':
    ...
    trainer.fit(model, train_loader, val_dataloaders=[hpatch_i_dataloader, hpatch_v_dataloader, imw2020val_dataloader])
